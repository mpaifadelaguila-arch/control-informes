...
if not df.empty:
    ...
    with t_gen:
        ...
        modo_edicion = c_sw.toggle("✏️ Habilitar Edición", value=False)
        ...
        if modo_edicion:
            # Vista interactiva para modificar celdas
            ...
            # Vista estática con resaltado de colores completo por fila
